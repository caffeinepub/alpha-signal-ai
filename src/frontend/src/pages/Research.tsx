  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground font-mono">
        GEMINI-1.5-PRO · DEEP ANALYSIS IN PROGRESS
      </p>
    </div>
  );
}
      ...
      <AnimatePresence>
        {error && !isLoading && (
          <motion.div
            ...
            className="flex items-start gap-3 p-4 rounded-lg border border-red-500/30 bg-red-500/10 text-red-400"
          >
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground max-w-sm">
                ...
                institutional-grade AI analysis powered by Gemini 1.5 Pro.
              </p>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-yellow-300/70 leading-relaxed">
                  Fundamental metrics are generated by Gemini 1.5 Pro based on
