...
import type { UserProfile as _UserProfile, UserRole as _UserRole, VideoDifficulty as _VideoDifficulty } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addVideo(arg0: string, arg1: string, arg2: string, arg3: string, arg4: VideoDifficulty): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addVideo(arg0, arg1, arg2, arg3, to_candid_VideoDifficulty_n1(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async geminiTransform(arg0: TransformationInput): Promise<TransformationOutput> {
        if (this.processError) {
            try {
                const result = await this.actor.geminiTransform(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async proxyGemini(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.proxyGemini(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async researchWithGemini(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.researchWithGemini(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_VideoDifficulty_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VideoDifficulty): _VideoDifficulty {
    return to_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VideoDifficulty): {
    beginner: null;
} | {
    advanced: null;
} {
    return value == VideoDifficulty.beginner ? {
        beginner: null
    } : value == VideoDifficulty.advanced ? {
        advanced: null
    } : value;
}
